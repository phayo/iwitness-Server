    ...
    val scn = scenario("Test the Device entity")
        ...
        .repeat(2) {
            ...
            .body(StringBody("""{
                ...
                , "hash":"SAMPLE_TEXT"
                , "name":"SAMPLE_TEXT"
                , "linkDate":"2020-01-01T00:00:00.000Z"
                , "blacklistDate":"2020-01-01T00:00:00.000Z"
                , "blacklistReason":"SAMPLE_TEXT"
                , "imei":"SAMPLE_TEXT"
                , "cameraPermGranted":"2020-01-01T00:00:00.000Z"
                , "locationPermGranted":"2020-01-01T00:00:00.000Z"
                , "bgInternetPermGranted":"2020-01-01T00:00:00.000Z"
                , "status":"BLACKLISTED"
                , "os":"ANDROID_OS"
                }""")).asJson
            .check(status.is(201))
