...
@RestController
@RequestMapping("/api/iwitness-kafka")
public class IwitnessKafkaResource {

    private final Logger log = LoggerFactory.getLogger(IwitnessKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public IwitnessKafkaResource(KafkaProperties kafkaProperties) {
